<template>
  <div class="page-shell">
    <section class="hero-panel">
      <div class="hero-title">全局调用记录</div>
      <div class="hero-subtitle">
        从平台视角查看所有用户和所有应用的调用行为，支持按用户名、状态、时间范围筛选，并下钻查看模型级别的处理细节。
      </div>
      <div class="hero-meta">
    ...
    <section class="toolbar-panel glass-panel">
      ...
      <div class="toolbar-actions">
        <el-form :model="searchData" :inline="true">
          <el-form-item>
            <el-input type="text" placeholder="用户名" v-model="searchData.username" clearable style="width: 150px"></el-input>
          </el-form-item>
...
import { pageInvokeRecordApi, queryInvokeRecordOverviewApi } from '@/api/invokeRecordApi';
