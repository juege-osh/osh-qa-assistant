...
import type { AnyObjDefine, AnyObjsDefine, UseTableOptDefine} from "@/types/common.d.ts"
...
export function useTable(opts:UseTableOptDefine) {
    ...
    let searchData = reactive<AnyObjDefine>(Object.assign({
      pageNow: 1,
      pageSize: 50
    }, searchFormData))
