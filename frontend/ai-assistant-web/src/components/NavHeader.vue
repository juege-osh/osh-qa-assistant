      ...
      <el-col :span="20" :offset="2">
        <el-menu :default-active="activeItem" mode="horizontal" :ellipsis="false" @select="handleSelect">
          <div class="nav-left">
            ...
            <el-menu-item v-if="isAdmin" index="/admin/manager/manage"><el-icon>
                <User />
              </el-icon>管理台</el-menu-item>
            <el-menu-item v-if="isAdmin" index="/admin/user/manage"><el-icon>
                <Avatar />
              </el-icon>用户</el-menu-item>
            <el-menu-item v-if="isWorkspaceUser" index="/workspace/app/manage"><el-icon>
                <ChatDotRound />
              </el-icon>应用</el-menu-item>
            <el-menu-item v-if="isWorkspaceUser" index="/workspace/knowledgeLib/manage"><el-icon>
                <Document />
          ...
          <div class="nav-right" v-if="hasLogin">
            <el-sub-menu index="/user-submenu">
              ...
              <template v-if="hasLogin">
                <el-menu-item v-if="isWorkspaceUser" index="/user-submenu/profile" @click="openUpdateProfileDialog(userStore.userInfo.id)">修改个人信息</el-menu-item>
                <el-menu-item v-if="isWorkspaceUser" index="/user-submenu/pwd" @click="openUpdatePwd">修改密码</el-menu-item>
          ...
          <div class="nav-right" v-else>
            ...
            <el-button type="success" @click="router.replace('/register')">用户注册</el-button>
          </div>
        </el-menu>
        <!-- 修改个人信息对话框 -->
