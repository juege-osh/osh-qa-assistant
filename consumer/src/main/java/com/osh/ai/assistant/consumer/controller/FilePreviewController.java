...
public class FilePreviewController {
    ...
    public Result<FilePreviewVO> preview(@RequestParam("id") Long id) {
        ...
        result.setSplitConfig(ragDocumentSplitService.getSplitConfig());
        ...
        try {
            ...
            List<Document> splitDocuments = ragDocumentSplitService.splitDocuments(rawDocuments);
            result.setContent(truncate(content));
            result.setChunkCount(splitDocuments.size());
            result.setChunks(ragDocumentSplitService.buildChunkPreview(splitDocuments));
        } catch (BizEx e) {
